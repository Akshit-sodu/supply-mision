...
function setup() {
	...
	boxSide1= createSprite(width/2,650,200,20,{isStatic:true, restitution: 0.4});
	boxSide1.shapeColor=color("red")

	boxSide2=createSprite(290,620,20,100,{isStatic:true, restitution: 0.4});
	boxSide2.shapeColor=color("red")

	boxSide3=createSprite(510,620,20,100,{isStatic:true, restitution: 0.4});
